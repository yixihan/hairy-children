...
CREATE TABLE `title`  (
  ...
  `title_type` int(11) NULL DEFAULT NULL COMMENT '文章类型, 1 : 领养, 2 : 寻宠',
  `title_img` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '/title/default.png' COMMENT '文章预览图',
...
CREATE TABLE `user_info`  (
  ...
  `user_birth` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '用户生日',
